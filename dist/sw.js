const CACHE='dessica-cc963d84e68a';
const ASSETS=['./','./index.html','./source.html','./campaign.json','./Dessica_Campaign.md','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
