# SUPERSEDED — rejected first proposal

Do not implement this proposal. The creator corrected/rejected material assumptions. Read Campaign_Notes_Review_2026-09-17.md for the current decision record. The underlying baseline measurements remain historical evidence, not validation of these proposals.
