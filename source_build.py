...
DOCUMENTS = [
 ('Campaign_Notes_Review_2026-09-17.md', 'Campaign notes: findings and proposals'),
 ('Integrated_Balance_Baseline_Report.md', '216-campaign baseline'),
 ('Integrated_Balance_Review.md', 'Connected balance review plan'),
 ('Simulation_Readiness_Report.md', 'Balance testing readiness'),
